...
class SamplingMachine(object):
    ...
    def get_ordered_clusters(self, labels=None, num_clusters=None, order='biggest',
        ...
        if order == 'biggest':
            ...
            if self.clustering_value == None:
                ...
                self.evaluate_clusters(cls, verbose=False)
                print('Done.')
    ...
    def generate_positive_samples(self, num_samples, num_clusters=None, data=None, 
                                  ...
                                  which_cluster=None, clust_max_dep=3, verbose=True):
        """
        ...
        for c in clusters:
            ...
            if (cluster_num and which_cluster == counter) or not cluster_num:
                if verbose: print("Size of the cluster: {}".format(len(cluster_data)))
                if verbose: print("Size of the sample: {}".format(len(sample_data)))
    ...
    def sample_from_clusters(self, num_samples, all_data=None, num_clusters=None, data=None,
                             ...
                             clust_max_dep=CLUSTER_DEPTH, verbose=True):
        """
    ...
    def evaluate_clusters(self, cluster_formulas, value='weighted_sum', verbose=True):
        """
        ...
        if verbose: print("Value of clustering: {}".format(clust_val))
        return clust_val
