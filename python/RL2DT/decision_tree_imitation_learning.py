...
def formula_validation(best_formula, expert_reward, num_rollouts, normalizer, 
    ...
    print("\n\nExpert received an average reward of {}, ".format(rew_expert) + \
          ...
          "which makes the divergence equal to {}%".format(abs(rew_formula-rew_expert)/abs(normalizer) * 100))
